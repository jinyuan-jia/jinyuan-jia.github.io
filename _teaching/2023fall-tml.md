...
| 7 | 10/03 | Backdoor attacks to pre-trained foundation models | 1. BadEncoder: Backdoor Attacks to Pre-trained Encoders in Self-Supervised Learning <br/> 2. (Optional) Poisoning and Backdooring Contrastive Learning|Speakers: Harish Kolla, Girish Nagarajan|
